...
let favoriteFoods = ['blueberries', 'cheese', 'pasta'];
...
let animalToPush = 'lion';
animalArray.push(animalToPush);
console.log('Added(push) animal:', animalArray);
...
//      array. (How can you be 100% certain this worked? 🤔)
 ...
 console.log("Favorite food with dessert pushed to end", favoriteFoods);
...
console.log('Added(unshift) entrees to beginning:', favoriteFoods);
...
console. log ("Pop/remove last color", colors);
console. log("Removed(pop) color:", lastColor)
...
console. log("Removed first color(unshift) in new variable firstColor: ", firstColor); 
